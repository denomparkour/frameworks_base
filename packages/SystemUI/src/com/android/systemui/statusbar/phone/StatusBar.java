...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    public void start() {
        ...
        mAtomSettingsObserver.observe();
        mAtomSettingsObserver.update();
    ...
    private AtomSettingsObserver mAtomSettingsObserver = new AtomSettingsObserver(mHandler);
    private class AtomSettingsObserver extends ContentObserver {
        AtomSettingsObserver(Handler handler) {
            super(handler);
        }
